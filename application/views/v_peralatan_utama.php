  ...
  <div class="card-header">
    ...
    <div class="form-group mb-2" style="margin-right: 10px;">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
              Input Data Persyaratan Peralatan Utama
                </button>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Persyaratan Peralatan Utama</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form method="post" action="<?php echo base_url().'index.php/peralatan_utama/tambah_aksi'; ?>" >
    ...
    <div card-body>
        <table style="padding: 10px; " class="table table-bordered" id="table">
                      ...
                      <tbody>
                        ...
                        foreach ( $peralatan_utama -> result () as $row )
 {
         ...
         <div class="modal fade" id="modal_<?php echo $row->id_persyaratan_peralatan;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url().'index.php/peralatan_utama/update'; ?>" >
                      <div class="modal-body">
                      <div class="form-group">
                        <label>Nama Alat</label>
                      ...
                      <button class="btn btn-info">Simpan</button>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form method="post" action="<?php echo base_url().'index.php/peralatan_utama/hapus/'.$row->id_persyaratan_peralatan ?>">
                                <div class="form-group">
