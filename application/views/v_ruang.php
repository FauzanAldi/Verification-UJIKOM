...
<div class="card" style="padding: 20px 50px 50px 50px; ">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Persyaratan Ruang</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form method="post" action="<?php echo base_url().'index.php/ruangan/tambah_aksi'; ?>" >
                      <div class="modal-body">
                      <div class="form-group">
                        <label>Indikator Persyaratan Ruang</label>
                        <input type="hidden" name="id_paket" value="<?php echo $id_paket ?>">
                        <input class="form-control" type="text" name="persyaratan_ruang" >
                    </div>
    ...
    <div card-body>
        <table style="padding: 10px; " class="table table-bordered" id="table">
                      <thead>
                        <tr>
                          <th scope="col" >#</th>
                          <th scope="col" >Persyaratan Tempat</th>
                        ...
                        foreach ( $ruangan -> result () as $row )
 {
         ...
         ?>
         <div class="modal fade" id="modal_<?php echo $row->id_persyaratan_ruang;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Persyaratan Ruangan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                   <form method="post" action="<?php echo base_url().'index.php/ruangan/update'; ?>" >
                      <div class="modal-body">
                      <div class="form-group">
                        <label>Indikator Persyaratan Ruang</label>
                        <input type="hidden" name="id" value="<?php echo $row->id_persyaratan_ruang ?>">
                        <input type="hidden" name="id_paket" value="<?php echo $id_paket ?>">
                        <input class="form-control" type="text" name="persyaratan_ruang" value=" <?php echo  $row->persyaratan_ruang; ?>">
                    </div>
                    ...
                    <div class="modal-footer">
                     <!--  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> -->
                      <button class="btn btn-info">Simpan</button>
                        ...
                        <tr>
                          <th scope="row"><input type="checkbox" name="<?php echo $row->id_persyaratan_ruang;?>">
                          <td><?php echo $row -> persyaratan_ruang ;?></td>
                          <td>
                            <button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#modal_<?php echo $row->id_persyaratan_ruang;?>" >
                              <i class="fa fa-edit"></i> Edit
                            </button>
                            <form method="post" action="<?php echo base_url().'index.php/ruangan/hapus/'.$row->id_persyaratan_ruang ?>">
                                <div class="form-group">
