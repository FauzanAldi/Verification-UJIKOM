...
<div class="card" style="padding: 20px 50px 50px 50px; ">
  <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <form   class="" method="post" action="<?php echo base_url().'index.php/sekolah/tambah_aksi' ?>" >
    ...
    <hr>
      ...
      <div class="form-group" style="margin-right: 20px; padding: 10px;">
                        ...
                        <input class="form-control" type="text" name="nama_sekolah" style="margin-left: 20px;" >
                    </div>
                     <div class="form-group">
                        <label>Alamat Sekolah :</label><br>
                        <textarea cols="40" rows="4" name="alamat_sekolah" style="margin-left: 20px;"></textarea>
                        ...
                        foreach ( $jurusan -> result () as $row )
 {
         ...
         ?>
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="jumlah_peserta_<?php echo $row->id_jurusan;?>" placeholder="Masukkan Jumlah Peserta" style="border: 0"></td>
                          <td>
                            <?php 
                    ...
                    $query=$this->db->query("SELECT * FROM paket  where id_jurusan='$id_jur' ");
                            ...
                            <select name="paket_<?php echo $row->id_jurusan;?>">
                              ...
                              <?php foreach ( $query->result () as $pak )
                                    {
                                      ?>
                              <option value="<?php echo $pak->id_paket;  ?>">
