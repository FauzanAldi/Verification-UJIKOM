...
<div class="card" style="padding: 20px 50px 50px 50px; ">
    ...
    <div class="form-group mb-2" style="margin-right: 10px;">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
              Input Data Persyaratan Penguji Eksternal
                </button>
                <hr>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Persyaratan Penguji Eksternal</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form method="post" action="<?php echo base_url().'index.php/penguji_eksternal/tambah_aksi'; ?>" >
                      <div class="modal-body">
                      <div class="form-group">
                        <label>Indikator Persyaratan Penguji Eksternal</label>
                        <input type="hidden" name="id_paket" value="<?php echo $id_paket ?>">
                        <input class="form-control" type="text" name="persyaratan_penguji_eksternal" >
                    </div>
    ...
    <div card-body>
        <table style="padding: 10px; " class="table table-bordered" id="table">
                      ...
                      <tbody>
                        ...
                        foreach ( $penguji_eksternal -> result () as $row )
 {
         ...
         <div class="modal fade" id="modal_<?php echo $row->id_persyaratan_penguji;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                   ...
                   <form method="post" action="<?php echo base_url().'index.php/penguji_eksternal/update'; ?>" >
                      <div class="modal-body">
                      <div class="form-group">
                        <label>Indikator Persyaratan Penguji Eksternal</label>
                        <input type="hidden" name="id" value="<?php echo $row->id_persyaratan_penguji ?>">
                        <input type="hidden" name="id_paket" value="<?php echo $id_paket ?>">
                        <input class="form-control" type="text" name="persyaratan_penguji_eksternal" value=" <?php echo  $row->persyaratan_penguji; ?>">
                    </div>
                      ...
                      <button class="btn btn-info">Simpan</button>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form method="post" action="<?php echo base_url().'index.php/penguji_eksternal/hapus/'.$row->id_persyaratan_penguji ?>">
                                <div class="form-group">
